...
figure1.a <- ggplot(aes(x = PC1, y = PC2),data = info.x.pca.data) + 
  ...
  labs(x = paste("PC1 (",var.pca.data[1]*100,"%)",sep = ""),
       ...
       title = "Figure 1. A",
       subtitle = "Principal component analysis (PCA) based on 4,393 SNP markers: All Sub-populations") +
  theme_bw() +
...
figure1.b <- ggplot(aes(x = PC1, y = PC2),data = info.x.pca2.data.filt) + 
  ...
  labs(x = paste("PC1 (",var.pca2.data.filt[1]*100,"%)",sep = ""),
       ...
       title = "Figure 1. B",
       subtitle = "Principal component analysis (PCA) based on 4,393 SNP markers: 3 large fruited sub-populations") +
  theme_bw() +
  theme(aspect.ratio = 1)
